...
def test_gets_the_name(parsed_glossary_uscourts: GlossarySourceParseResult):
    assert (
...
def test_phrase_does_not_end_with_colon(
    parsed_glossary_uscourts: GlossarySourceParseResult,
):
    assert parsed_glossary_uscourts.entries[0].phrase == "Alienated Parent"


@mark.skip(reason="Not implemented yet")
def test_gets_the_url(parsed_glossary_uscourts: GlossarySourceParseResult):
    assert (
...
@mark.skip(reason="Not implemented yet")
def test_gets_the_author(parsed_glossary_uscourts: GlossarySourceParseResult):
    assert parsed_glossary_uscourts.metadata.dcterms_creator == "https://public.law"


@mark.skip(reason="Not implemented yet")
def test_gets_the_scrape_date(parsed_glossary_uscourts: GlossarySourceParseResult):
...
@mark.skip(reason="Not implemented yet")
def test_gets_a_term_case_1(parsed_glossary_uscourts: GlossarySourceParseResult):
...
@mark.skip(reason="Not implemented yet")
def test_parses_emphasized_text(parsed_glossary_uscourts: GlossarySourceParseResult):
