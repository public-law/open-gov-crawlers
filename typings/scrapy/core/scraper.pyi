...
from typing import AsyncIterable, Iterable, Tuple, Union
...
class Scraper:
    ...
    @inlineCallbacks
    def open_spider(self, spider: Spider): # -> Generator[Unknown | Any, Any, None]:
    ...
    def handle_spider_output(self, result: Union[Iterable, AsyncIterable], request: Request, response: Response, spider: Spider) -> Deferred:
        ...
