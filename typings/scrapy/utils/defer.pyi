...
from typing import Any, AsyncGenerator, AsyncIterable, Callable, Coroutine, Generator, Iterable, Iterator, Union
...
class _AsyncCooperatorAdapter(Iterator):
    ...
    goal.
    """
    def __init__(self, aiterable: AsyncIterable, callable: Callable, *callable_args, **callable_kwargs) -> None:
        ...
