...
class ProgressBar(StdRedirectMixin, ResizableMixin, ProgressBarBase):
    ...
    @property
    def dynamic_messages(self): # -> AttributeDict:
        ...
    
    @dynamic_messages.setter
    def dynamic_messages(self, value): # -> None:
        ...
    ...
    def set_last_update_time(self, value): # -> None:
        ...
    ...
    def default_widgets(self): # -> list[Percentage | str | SimpleProgress | Bar | Timer | AdaptiveETA] | list[AnimatedMarker | str | BouncingBar | Counter | Timer]:
        ...
    
    def __call__(self, iterable, max_value=...): # -> Self@ProgressBar:
    ...
    next = ...
    def __iadd__(self, value): # -> Self@ProgressBar:
        'Updates the ProgressBar by adding a new value.'
        ...
    
    def increment(self, value=..., *args, **kwargs): # -> Self@ProgressBar:
        ...
    
    def update(self, value=..., force=..., **kwargs): # -> None:
        'Updates the ProgressBar to a new value.'
        ...
    
    def start(self, max_value=..., init=...): # -> Self@ProgressBar:
    ...
    def finish(self, end=..., dirty=...): # -> None:
        '''
...
class DataTransferBar(ProgressBar):
    ...
    '''
    def default_widgets(self): # -> list[Percentage | str | DataSize | Bar | Timer | AdaptiveETA] | list[AnimatedMarker | str | DataSize | Timer]:
        ...
...
class NullBar(ProgressBar):
    ...
    flags
    '''
    def start(self, *args, **kwargs): # -> Self@NullBar:
        ...
    
    def update(self, *args, **kwargs): # -> Self@NullBar:
        ...
    
    def finish(self, *args, **kwargs): # -> Self@NullBar:
        ...
