...
def thread_first(val, *forms): # -> None:
...
def thread_last(val, *forms): # -> None:
    """ Thread value through a sequence of functions/forms
...
def instanceproperty(fget=..., fset=..., fdel=..., doc=..., classval=...): # -> partial[Unknown] | InstanceProperty:
...
class InstanceProperty(property):
    ...
    def __reduce__(self): # -> tuple[Type[InstanceProperty], tuple[((Any) -> Any) | None, ((Any, Any) -> None) | None, ((Any) -> None) | None, str | None, Unknown]]:
        ...
...
class curry:
    ...
    def __call__(self, *args, **kwargs): # -> Self@curry:
        ...
    
    def bind(self, *args, **kwargs): # -> Self@curry:
        ...
    
    def call(self, *args, **kwargs):
        ...
    
    def __get__(self, instance, owner): # -> Self@curry | curry:
        ...
    
    def __reduce__(self): # -> tuple[(cls: Unknown, func: Unknown, args: Unknown, kwargs: Unknown, userdict: Unknown, is_decorated: Unknown) -> (ModuleType | Any | Unknown), tuple[Type[Self@curry], str | (() -> ((...) -> Unknown)), () -> tuple[Any, ...], () -> dict[str, Any], tuple[tuple[str, Any], ...], bool | None]]:
        ...
...
class Compose:
    ...
    def __getstate__(self): # -> tuple[Unknown, tuple[Unknown, ...] | Unknown]:
        ...
    ...
    @property
    def __name__(self): # -> str | property:
        ...
    ...
    def __get__(self, obj, objtype=...): # -> Self@Compose | MethodType:
        ...
...
def compose(*funcs): # -> ((x: Unknown) -> Unknown) | Compose:
...
def compose_left(*funcs): # -> ((x: Unknown) -> Unknown) | Compose:
    """ Compose functions to operate in series.
...
def complement(func): # -> ((x: Unknown) -> Unknown) | Compose:
...
class juxt:
    ...
    def __call__(self, *args, **kwargs): # -> tuple[Unknown, ...]:
        ...
    
    def __getstate__(self): # -> tuple[Unknown, ...]:
        ...
...
class excepts:
    ...
    @instanceproperty(classval=__doc__)
    def __doc__(self): # -> str | ((self: Self@excepts) -> ...):
        ...
...
if PYPY:
    _check_sigspec_orig = ...
def num_required_args(func, sigspec=...): # -> int | None:
    ...
