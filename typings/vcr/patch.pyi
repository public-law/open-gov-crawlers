...
def reset_patchers(): # -> Generator[_patch[_HTTPConnection] | _patch[_HTTPSConnection] | _patch[Unknown | VerifiedHTTPSConnection] | _patch[Unknown | HTTPConnection] | _patch[Unknown | HTTPSConnection] | _patch[Unknown] | _patch[_HTTPConnectionWithTimeout] | _patch[_HTTPSConnectionWithTimeout] | _patch[(self: SimpleAsyncHTTPClient, request: HTTPRequest, callback: (HTTPResponse) -> None) -> None] | _patch[(self: CurlAsyncHTTPClient, request: HTTPRequest, callback: (HTTPResponse) -> None) -> None], None, None]:
    ...
